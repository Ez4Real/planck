...
import type {
  ...
  SubscribersReadSubscribersData,
  SubscribersReadSubscribersResponse,
  SubscribersCreateSubscriberData,
  SubscribersCreateSubscriberResponse,
  SubscribersReadSubscriberData,
...
export class ProductsService {
  ...
  public static uploadImages(
    data: ProductsUploadImagesData,
  ): CancelablePromise<ProductsUploadImagesResponse> {
    return __request(OpenAPI, {
      method: "POST",
...
export class SubscribersService {
  ...
  public static readSubscribers(
    data: SubscribersReadSubscribersData = {},
  ): CancelablePromise<SubscribersReadSubscribersResponse> {
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static createSubscriber(
    data: SubscribersCreateSubscriberData,
  ): CancelablePromise<SubscribersCreateSubscriberResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/subscribers/",
      body: data.requestBody,
  ...
  public static readSubscriber(
    data: SubscribersReadSubscriberData,
  ): CancelablePromise<SubscribersReadSubscriberResponse> {
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static deleteSubscriber(
    data: SubscribersDeleteSubscriberData,
  ): CancelablePromise<SubscribersDeleteSubscriberResponse> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/v1/subscribers/{id}",
      path: {
