    ...
    >
      ...
      <Box pr="34px">
        ...
        <Box mt="42px">
          ...
          <Text mt="8px">Vishal Rai, Sudarshan Bhide</Text>
          <List.Root
            color="ui.muted"
            lineHeight="28px"
            mt="16px"
          ...
          >
            <List.Item>
              UK residents: Lodge complaints with the Information Commissioner’s Office (ICO) at <span
                style={{textDecoration: "underline"}}>www.ico.org.uk.
              </span>
            </List.Item>
            <List.Item>EU residents: File complaints with your local Data Protection Authority (DPA).</List.Item>
            <List.Item>Indian residents: Contact the Data Protection Board of India.</List.Item>
            <List.Item>California residents: Submit CCPA/CPRA requests via the contact details above.</List.Item>
          </List.Root>
        </Box>
      </Box>
    </Container>
